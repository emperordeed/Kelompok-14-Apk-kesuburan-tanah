...
import 'package:tanah/karakter_tanah.dart';
// import 'package:tesd_drawer/Input.dart';
// import 'package:tesd_drawer/Pages/Dashboard_page.dart';
// import 'package:tesd_drawer/karakter_tanah.dart';

import 'About_page.dart';
import 'Dashboard_page.dart';
import 'Diagnosa_page.dart';

class DaftarTanahPage extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Daftar Tanah'),
      ),
      drawer: Drawer(
          child: Column(
        children: [
